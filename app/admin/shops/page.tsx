                      ...
                      <div className="flex min-w-0 items-start gap-5">
                        ...
                        <div className="min-w-0">
                          <div className="flex flex-wrap items-center gap-2">
                            ...
                            <span className={`rounded-full px-2.5 py-1 text-[11px] font-semibold ${item.isActive ? "bg-green-100 text-green-700" : "bg-neutral-200 text-neutral-600"}`}>
                              {item.isActive ? "Active" : "Hidden"}
                            </span>
                            <span className={`rounded-full px-2.5 py-1 text-[11px] font-semibold ${item.inStock ? "bg-blue-100 text-blue-700" : "bg-red-100 text-red-700"}`}>
                          ...
                          <div className="mt-3 grid gap-2 text-[11px] text-neutral-700 sm:grid-cols-[repeat(auto-fit,minmax(96px,1fr))]">
                            {sizePrices.length ? (
                              sizePrices.map((entry) => (
                                <div
                                  key={entry.size}
                                  className="rounded-2xl border border-neutral-200 bg-white px-3 py-2 text-center"
                                >
