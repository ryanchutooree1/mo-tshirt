                ...
                <div className="mt-1 flex items-center gap-3">
                  ...
                  {garmentLines.length > 1 ? (
                    <button
                      ...
                      className="inline-flex aspect-square h-9 w-9 items-center justify-center rounded-full border border-rose-200 bg-gradient-to-br from-rose-50 to-red-100 text-lg font-semibold text-rose-600 shadow-[0_10px_20px_-16px_rgba(244,63,94,0.45)] transition hover:from-rose-100 hover:to-red-100 hover:text-rose-700"
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
              <div className="md:col-start-4">
                ...
                <input
                  ...
                  className="mt-1 w-full cursor-default rounded-lg border border-neutral-200 bg-neutral-50 px-3 py-2 text-sm font-semibold text-neutral-700 shadow-[inset_0_1px_2px_rgba(15,23,42,0.06),0_14px_28px_-24px_rgba(15,23,42,0.35)] focus:outline-none"
                />
              </div>
            </div>
          ) : null}
