            ...
            <div className="mt-5 grid gap-3">
              {filtered.length === 0 ? (
                ...
                filtered.map((detail) => {
                  ...
                  return (
                    <div key={detail.id} className="group rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
                        ...
                        <div className="flex flex-col items-end gap-2">
                          ...
                          <div className="flex items-center gap-2 opacity-70 transition group-hover:opacity-100">
                            <button
                              ...
                              className="inline-flex items-center justify-center rounded-full border border-slate-200 bg-white p-2 text-slate-500 transition hover:border-slate-300 hover:bg-slate-50 hover:text-slate-700"
                            >
                            ...
                            <button
                              ...
                              className="inline-flex items-center justify-center rounded-full border border-rose-200 bg-rose-50 p-2 text-rose-600 transition hover:border-rose-300 hover:bg-rose-100"
                            >
