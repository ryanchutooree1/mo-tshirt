...
const PAGE_ICONS: Partial<Record<AdminPagePath, LucideIcon>> = {
  ...
  "/admin/home-overview": LayoutDashboard,
  "/admin/home-bills": ReceiptText,
  "/admin/home-maintenance": Wrench,
  "/admin/home-calendar": CalendarDays,
  "/admin/home-documents": FolderOpen,
  "/admin/docker-postgres": Database,
