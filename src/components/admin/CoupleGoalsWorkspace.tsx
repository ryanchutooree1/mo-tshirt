...
export type CoupleGoalsWorkspaceView = "couple-goals" | "tanvi-food";

export default function CoupleGoalsWorkspace({
  view,
}: {
  view: CoupleGoalsWorkspaceView;
}) {
  const isFoodView = view === "tanvi-food";
